...
struct ChannelRuntimeDefaults {
    ...
    empty_response_policy: crate::config::EmptyResponsePolicy,
...
fn runtime_defaults_from_config(config: &Config) -> ChannelRuntimeDefaults {
    ...
    ChannelRuntimeDefaults {
        ...
        empty_response_policy: config.agent.empty_response_policy,
...
fn runtime_defaults_snapshot(ctx: &ChannelRuntimeContext) -> ChannelRuntimeDefaults {
    ...
    ChannelRuntimeDefaults {
        ...
        empty_response_policy: crate::config::EmptyResponsePolicy::default(),
        ...
        result = tokio::time::timeout(
            ...
            crate::agent::loop_::scope_cost_enforcement_context(
                ...
                crate::agent::loop_::scope_deferred_action_policy(
                    ...
                    crate::agent::loop_::scope_empty_response_policy(
                        runtime_defaults.empty_response_policy,
